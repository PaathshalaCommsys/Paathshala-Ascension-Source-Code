...
JNIEXPORT int Java_org_paathshala_commsys_Utilities_needInvert(JNIEnv *env, jclass class, jobject bitmap, jint unpin, jint width, jint height, jint stride) {
    if (!bitmap) {
        return 0;
    }
...
JNIEXPORT void Java_org_paathshala_commsys_Utilities_blurBitmap(JNIEnv *env, jclass class, jobject bitmap, jint radius, jint unpin, jint width, jint height, jint stride) {
    if (!bitmap) {
        return;
    }
...
JNIEXPORT void Java_org_paathshala_commsys_Utilities_calcCDT(JNIEnv *env, jclass class, jobject hsvBuffer, jint width, jint height, jobject buffer) {
...
JNIEXPORT jint Java_org_paathshala_commsys_Utilities_pinBitmap(JNIEnv *env, jclass class, jobject bitmap) {
    if (bitmap == NULL) {
        return 0;
    }
...
JNIEXPORT void Java_org_paathshala_commsys_Utilities_unpinBitmap(JNIEnv *env, jclass class, jobject bitmap) {
    if (bitmap == NULL) {
        return;
    }
    AndroidBitmap_unlockPixels(env, bitmap);
...
JNIEXPORT jboolean Java_org_paathshala_commsys_Utilities_loadWebpImage(JNIEnv *env, jclass class, jobject outputBitmap, jobject buffer, jint len, jobject options, jboolean unpin) {
    if (!buffer) {
...
JNIEXPORT void Java_org_paathshala_commsys_Utilities_stackBlurBitmap(JNIEnv* env, jclass class, jobject bitmap, jint radius){
    if(radius<1) return;
