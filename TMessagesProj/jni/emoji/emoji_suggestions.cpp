...
jobjectArray
Java_org_paathshala_commsys_Emoji_getSuggestion(JNIEnv *env, jobject object, jstring query) {
    ...
    if (jclass_Suggestion == nullptr) {
        jclass_Suggestion = (jclass) env->NewGlobalRef(env->FindClass("org/paathshala/commsys/EmojiSuggestion"));
